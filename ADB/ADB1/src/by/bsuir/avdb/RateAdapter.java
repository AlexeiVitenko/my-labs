...
public class RateAdapter extends CursorTreeAdapter {
	...
	protected void bindGroupView(View view, Context context, Cursor cursor,
			boolean isExpanded) {
		((TextView) view).setText("Rate: "
				+ cursor.getString(cursor.getColumnIndex(DBColumns.RATE)));
	}
	...
	protected void bindChildView(View view, Context context, Cursor cursor,
		...
		boolean buy = cursor.getLong(cursor
				.getColumnIndex(DBHelper.DBColumns.BUY_CELL)) == 1 ? true
				: false;
		tv.setText("RATE: "
				+ cursor.getString(cursor
						.getColumnIndex(DBHelper.DBColumns.RATE)) + ", BUY: "
				+ buy + ", count: "
